...
from models.dgcnn import DGCNN, DGCNNSeg_att
...
def pretrain(args):
    ...
    CLASS2SCANS = {c: DATASET.class2scans[c] for c in CLASSES} # only use the train classes in class2scan
