...
if __name__ == '__main__':
    ...
    parser.add_argument('--triplet_loss_weight', type=float, default=-1, help='noise ratio in the support set')

    # gfs config
    parser.add_argument('--testing_data_path', type=str, default='', help='testing data path')
    ...
    if args.phase=='mptitrain':
        ...
        args.log_dir = os.path.join(args.save_path, 'log_mpti_S%d_N%d_K%d_Att%d_%s' % (args.cvfold,
                                    args.n_way, args.k_shot, args.use_attention, args.log_dir))
        ...
        args.log_dir = args.save_path + 'log_pretrain_%s_S%d_LongTail' % (args.dataset, args.cvfold)
